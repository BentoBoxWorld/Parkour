 ...
 * @author Tastybento
 */
@StoreAt(filename="config.yml", path="addons/Parkour") // Explicitly call out what name this should have.
@ConfigComment("Parkour Configuration [version]")
public class Settings implements WorldSettings {
    ...
    @ConfigEntry(path = "parkour.command.island")
    private String playerCommandAliases = "parkour pk";

    @ConfigComment("The admin command.")
    @ConfigComment("To define alias, just separate commands with white space.")
    @ConfigEntry(path = "parkour.command.admin")
    private String adminCommandAliases = "parkouradmin pkadmin";
    ...
    @ConfigEntry(path = "parkour.command.new-player-action")
    ...
    private String friendlyName = "Parkour";

    @ConfigComment("Name of the world - if it does not exist then it will be generated.")
    @ConfigComment("It acts like a prefix for nether and end (e.g. parkour_world, parkour_world_nether, parkour_world_end)")
    @ConfigEntry(path = "world.world-name")
    private String worldName = "parkour_world";
    ...
    @ConfigComment("The permission parkour.ban.maxlimit.X where X is a number can also be used per player")
    ...
    @ConfigComment("Mob white list - these mobs will NOT be removed when logging in or doing /parkour")
    ...
    @ConfigComment("Players can have the parkour.coop.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("Players can have the parkour.trust.maxsize.<number> permission to be bigger but")
    @ConfigComment("permission size cannot be less than the default below. ")
    ...
    @ConfigComment("This only affects BentoBox's own per-player death count, used by the %parkour_deaths% placeholder.")
    ...
    @ConfigComment("Parkour blocked mobs.")
    @ConfigComment("List of mobs that should not spawn in Parkour.")
